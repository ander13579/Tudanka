...
public class TudankaP1A extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tudanka_p1a);
        ...
        if(LENG.equals("Castellano"))
            ...
            all_questions = getResources().getStringArray(R.array.preguntasca);

        else {
            all_questions = getResources().getStringArray(R.array.preguntaseu);
        }
    ...
    private void checkResults() {
        final Intent Lenguaje = getIntent();
        ...
        String message =
                String.format("Correctas:Bilbao,\nFrancoren armada,\nUgao \nCorrectas: %d\nIncorrectas: %d\nNo contestadas: %d\n",
        ...
        builder.setPositiveButton(R.string.finish, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if((Lenguaje.getStringExtra(IDIOMA)).equals("Castellano")){
